...
"externalAdReply": {
                ...
                "sourceUrl": `https://youtube.com/channel/UCIEuAWtpsNa2GAS65NhDUJg`
...
if (budY.includes("hope")){
if (isFiltered2(sender)) return
await addFilter2(sender);

await sendMedia(from, goAudio + 'hope.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 

if (budY.includes("geme")){
if (isFiltered2(sender)) return
await addFilter2(sender);

await sendMedia(from, goAudio + 'geme.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 

if (budY.includes("jessica")){
if (isFiltered2(sender)) return
await addFilter2(sender);

await sendMedia(from, goAudio + 'jessica.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 
...
await sendMedia(from, goAudio + 'para.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 

if (budY.includes("pau")){
if (isFiltered2(sender)) return
await addFilter2(sender);

await sendMedia(from, goAudio + 'pau.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 

if (budY.includes("hum")){
if (isFiltered2(sender)) return
await addFilter2(sender);

await sendMedia(from, goAudio + 'hum.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 
...
await sendMedia(from, goAudio + 'pika.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 
...
await sendMedia(from, goAudio + 'hacker.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 
...
await sendMedia(from, goAudio + 'puta.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 

if (budY.includes("quem")){
if (isFiltered2(sender)) return
await addFilter2(sender);

await sendMedia(from, goAudio + 'quem.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 

if (budY.includes("tira do grupo")){
if (isFiltered2(sender)) return
await addFilter2(sender);

await sendMedia(from, goAudio + 'tira.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 

if (budY.includes("kkkk")){
if (isFiltered2(sender)) return
await addFilter2(sender);
...
if (budY.includes("werbert")){
if (isFiltered2(sender)) return
await addFilter2(sender);
mathHelp(7, 1);
await sendMedia(from, goSticker + 'werbert' + valorMath + '.webp', 'sticker', {
mimetype: Mimetype.sticker,
 quoted: mek,});

await sleep(1500);
await sendMedia(from, goAudio + 'werbert.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
} 
...
if (budY.includes("palmeiras") || (budY.includes("tem mundial"))) {
if (isFiltered2(sender)) return
await addFilter2(sender);
mathHelp(1, 1);
await sendMedia(from, goSticker + 'fla' + valorMath + '.webp', 'sticker', {
mimetype: Mimetype.sticker,
 quoted: mek,});
 await sleep(3000);
await sendMedia(from, goAudio + 'palmeiras.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
}

if (budY.includes("vou") || (budY.includes("vou conseguir"))) {
if (isFiltered2(sender)) return
await addFilter2(sender);
mathHelp(1, 1);
await sendMedia(from, goSticker + 'vou' + valorMath + '.webp', 'sticker', {
mimetype: Mimetype.sticker,
 quoted: mek,});
 await sleep(3000);
await sendMedia(from, goAudio + 'vou.mp3', 'audio', {
mimetype: Mimetype.mp4Audio,
 quoted: mek,
 ptt:true});
}
...
"externalAdReply": {
        ...
        "thumbnail":  fs.readFileSync(`./edit/media/image/selos/${mathSelo}.jpg`),
                "sourceUrl": `https://api.whatsapp.com/send?phone=5586981787294&text=Olá%20 Werbert, tudo bom? `
...
*esse bot é do Werbert,* você pode se inscrever no canal no YouTube:
https://youtube.com/channel/UCIEuAWtpsNa2GAS65NhDUJg
...
try {
        ...
        reply (`O Player 1 falhou... tentando no player 2...`)
        console.log(e);
        extraPlay(cArgs);
        }
        break;
...
await reply (` mais nomes em breve! visite meu canal no YouTube(WERBERT) para ter acesso às futuras atualizações!`)
break
